...
$file = fopen("api/files/alarme/log.txt", "r");
...
<head>
    ...
    <title>Histórico de Estado do Alarme</title>
    ...
    <div class="container">
        <div class="card boxes">
            <div class="card-body">
                ...
                <h1>Histórico de Estado do Alarme</h1>
    ...
    <div class="container">
        <div class="card boxes">
            <div class="card-header">
                <b>Tabela de Histórico de Estado do Alarme</b>
            </div>
            <div class="card-body">
                <table class="table">
                    <thead>
