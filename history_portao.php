...
$file = fopen("api/files/portao/log.txt", "r");
...
<head>
    ...
    <title>Histórico de Estado do Portão</title>
    ...
    <div class="container">
        <div class="card boxes">
            <div class="card-body">
                ...
                <h1>Histórico de Estado do Portão</h1>
    ...
    <div class="container">
        <div class="card boxes">
            <div class="card-header">
                <b>Tabela de Histórico de Estado do Portão</b>
            </div>
            <div class="card-body">
                <table class="table">
                    <thead>
                    ...
                    <tbody>
                        ...
                        foreach ($log_portao as $row) {
                            echo "<tr>";
                            echo "<td>Estado do Portão</td>";
                            echo "<td>" . $row[0] . "</td>";
                            if ($row[1] == 0) {
                                echo "<td>Fechado</td>";
                            } elseif ($row[1] == 1) {
