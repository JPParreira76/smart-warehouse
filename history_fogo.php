...
$file = fopen("api/files/fogo/log.txt", "r");
...
<head>
    ...
    <title>Histórico de Incêndio</title>
    ...
    <div class="container">
        <div class="card boxes">
            <div class="card-header">
                <b>Tabela de Histórico de Incêndio</b>
            </div>
            <div class="card-body">
                <table class="table">
                    <thead>
                    ...
                    <tbody>
                        ...
                        foreach ($log_fogo as $row) {
                            echo "<tr>";
                            echo "<td>Estado de Incêndio</td>";
                            echo "<td>" . $row[0] . "</td>";
                            if ($row[1] == 0) {
                                echo "<td>Sem Incêndio</td>";
                            } elseif ($row[1] == 1) {
                                echo "<td>Incêndio</td>";
                            }
                            echo "</tr>";
