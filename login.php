        ...
        <div class="row justify-content-center">
            <form class="login-form" method="post">
                ...
                <div class="mb-3">
                    ...
                    <input name="username" placeholder="Insira aqui o seu username" type="text" class="form-control" id="username" required>
                </div>
                <div class="mb-3">
                    <label class="form-label">Password</label>
                    <input name="password" placeholder="Insira aqui a sua Password" type="password" class="form-control" id="password" required>
                </div>
                <div>
                    <?php
