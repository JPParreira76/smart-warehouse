...
$file = fopen("api/files/distancia/log.txt", "r");
...
<head>
    ...
    <title>Histórico de Distância</title>
    ...
    <div class="container">
        <div class="card boxes">
            <div class="card-header">
                <b>Tabela de Histórico de Distância</b>
            </div>
            <div class="card-body">
                <table class="table">
                    <thead>
                    ...
                    <tbody>
                        ...
                        foreach ($log_distancia as $row) {
                            echo "<tr>";
                            echo "<td>Distância ao Portão</td>";
                            echo "<td>" . $row[0] . "</td>";
                            echo "<td>" . $row[1] . " metros</td>";
                            echo "</tr>";
                        }
                        ?>
                    </tbody>
