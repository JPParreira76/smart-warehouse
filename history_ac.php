...
$file = fopen("api/files/ac/log.txt", "r");
    ...
    <div class="container">
        <div class="card boxes">
            <div class="card-body">
                ...
                <h1>Histórico de Ar Condicionado</h1>
    ...
    <div class="container">
        <div class="card boxes">
            <div class="card-header">
                <b>Tabela de Histórico de Ar Condicionado</b>
            </div>
            <div class="card-body">
                <table class="table">
                    <thead>
                    ...
                    <tbody>
                        ...
                        foreach ($log_ac as $row) {
                            echo "<tr>";
                            echo "<td>Ar Condicionado</td>";
                            echo "<td>" . $row[0] . "</td>";
                            if ($row[1] == 0) {
